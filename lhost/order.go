...
var defaultorder = []string{
	...
	"Exim", "Sendmail", "Exchange2007", "Exchange2003", "InterScanMSS", "KDDI", "Verizon",
	"ApacheJames", "FML", "AmazonSES", "X2",

	// The following is a fallback list
	"Postfix", "OpenSMTPD", "qmail", "Courier", "MessagingServer", "MailMarshalSMTP", "Gmail", "GMX",
	"Zoho", "Domino", "Notes", "GoogleGroups", "MailFoundry", "V5sendmail", "IMailServer", "mFILTER",
	"Activehunter", "EZweb", "Biglobe", "EinsUndEins", "X1", "X3", "X6",
}
