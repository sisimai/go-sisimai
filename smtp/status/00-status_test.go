...
var ReasonList = []string{
	...
	eb.ReSIZE, eb.ReINET, eb.ReNRFC, eb.ReWONT, eb.ReRELA, eb.ReFROM, eb.ReQPTR, eb.ReSAFE, eb.ReSPAM,
	eb.ReRATE, eb.ReSTOP, eb.ReQUIT, eb.ReCOMM, eb.RePROC, eb.ReDISK, eb.ReEXEC,
