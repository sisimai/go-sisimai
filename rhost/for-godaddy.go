...
func init() {
	...
	ReturnedBy["GoDaddy"] = func(fo *siba.Fact) string {
		...
		errorcodes := map[string]string{
			...
			"IB501": eb.ReNRFC, // NotCompliantRFC
			...
			// - Add a valid "from" address and try to send the email again.
			"IB502": eb.ReNRFC, // NotCompliantRFC
