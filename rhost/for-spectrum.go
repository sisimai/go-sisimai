...
func init() {
	...
	ReturnedBy["Spectrum"] = func(fo *siba.Fact) string {
		...
		errorcodes := [][3]string{
			...
			//      IP you're connecting from, and check the IP address to ensure a reverse DNS entry
			//      exists for the IP. If the IP address is a Spectrum-provided email address, contact us.
			[3]string{"1100", "1150", eb.ReQPTR},
