...
// Package "rhost" provides functions for detecting bounce reason by matching error codes or error 
// error message patterns described in documents of each email services.
package rhost
