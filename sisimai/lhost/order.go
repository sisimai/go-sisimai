...
func OrderBySubject(title string) []string {
	...
	table := map[string][]string {
		...
		"delivery-status":       []string{"GoogleGroups", "OpenSMTPD", "AmazonSES", "Gmail", "X3", "GoogleWorkspace"},
...
func AnotherOrder() []string {
	...
	return []string{
		...
		"Exim", "Sendmail", "Office365", "Exchange2007", "Exchange2003", "AmazonSES", "InterScanMSS",
		"KDDI", "Verizon", "ApacheJames", "X2", "FML",

		// The following is a fallback list
		"Postfix", "GMX", "MessagingServer", "EinsUndEins", "Domino", "Notes", "qmail", "Courier",
		"OpenSMTPD", "Zoho", "MailFoundry", "V5sendmail", "mFILTER", "GoogleGroups", "Gmail", "EZweb",
		"IMailServer", "MailMarshalSMTP", "Activehunter", "Biglobe", "X1", "X3", "X6",
	}
}
