...
func Inquire(bf *sis.BeforeFact) sis.RisingUnderway {
	...
	for _, e := range(strings.Split(emailparts[0], "\n")) {
		...
		if reportpart {
			...
			// Source-IP: 192.0.2.1
			if strings.HasPrefix(e, "Original-Rcpt-To: ") {
	...
	for recipients == 0 {
		...
		dscontents[0].Recipient = sisiaddr.S3S4(emailparts[1][p1 + 4:p2]);     break
	}
