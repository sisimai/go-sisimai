...
fmt.Printf("IS-GOOGLE = %s", fo.Rhost)
		...
		messagesof := map[string][][]string{
			"authfailure": [][]string{
				...
				// - https://support.google.com/mail/answer/81126//authentication
				[]string{"451", "4.7.24", "the spf record of the sending domain"},
				[]string{"550", "5.7.24", "the spf record of the sending domain"},
				...
				// - https://support.google.com/mail/answer/81126//authentication
				[]string{"421", "4.7.26", "senders to authenticate with either spf or dkim"},
				[]string{"550", "5.7.26", "senders to authenticate with either spf or dkim"},
				...
				// - https://support.google.com/mail/answer/81126//authentication
				[]string{"550", "5.7.26", "fails to pass spf checks for an spf record with a hard fail"},
				[]string{"550", "5.7.26", "has an spf record with a hard fail policy"},
				...
				[]string{"451", "4.7.26", "is not accepted due to domain's dmarc policy"},
				[]string{"550", "5.7.26", "is not accepted due to domain's dmarc policy"},
				...
				[]string{"550", "5.7.1",  "fails to pass authentication checks"},
				[]string{"550", "5.7.26", "fails to pass authentication checks"},
				...
				//   not pass.
				[]string{"421", "4.7.27", "senders to authenticate with spf"},
				[]string{"421", "4.7.27", "senders to authenticate their email with spf"},
				[]string{"550", "5.7.27", "senders to authenticate with spf"},
				...
				[]string{"421", "4.7.30", "senders to authenticate their email with dkim"},
				...
				[]string{"550", "5.7.30", "senders to authenticate with dkim"},
				...
				//   domain.
				[]string{"421", "4.7.32", "aligned with either the authenticated spf or dkim"},
			},
			"badreputation": [][]string{
				...
				[]string{"421", "4.7.0", "very low reputation of the sending ip address"},
				[]string{"421", "4.7.0", "very low reputation of the sending domain"},
				...
				[]string{"550", "5.7.1", "due to the very low reputation of the sending ip address"},
				[]string{"550", "5.7.1", "due to the very low reputation of the sending domain"},
			},
			"blocked": [][]string{
				...
				[]string{"421", "4.7.0", "ip not in whitelist for rcpt domain"},
				...
				[]string{"421", "4.7.0", "try again later, closing connection."},

				// - 501 5.5.4 HELO/EHLO argument is invalid. https://support.google.com/mail/?p=helo
				[]string{"501", "5.5.4", "empty helo/ehlo argument not allowed"},
				[]string{"501", "5.5.4", "helo/ehlo argument is invalid"},
				...
				[]string{"421", "4.7.0",  "an unusual rate of unsolicited mail"},
				[]string{"421", "4.7.28", "an unusual rate of mail"},
				...
				[]string{"550", "5.7.1",  "an unusual rate of unsolicited mail"},
				[]string{"550", "5.7.28", "an unusual rate of unsolicited mail"},
			},
			"exceedlimit": [][]string{
				...
				[]string{"552", "5.2.3", "exceeded google's message size limits"},
				...
				[]string{"552", "5.3.4", "exceeds google's limit of limit attachments."},
				[]string{"552", "5.3.4", "your message exceeded google's message header size limits"},
				[]string{"552", "5.3.4", "bytes per individual header size"},
				[]string{"552", "5.3.4", "exceeds google's header name limit of"},
				[]string{"552", "5.3.4", "exceeds google's message header size limit"},
			},
			"expired": [][]string{
				...
				[]string{"421", "4.7.0", "connection expired"},
				...
				[]string{"451", "4.4.2", "timeout - closing connection"},
			},
			"mailboxfull": [][]string{
				...
				[]string{"452", "4.2.2", "inbox is out of storage space"},
				[]string{"552", "5.2.2", "inbox is out of storage space and inactive"},
				...
				[]string{"452", "4.2.2", "is over quota"},
				[]string{"552", "5.2.2", "is over quota"},
				[]string{"550", "5.7.1", "email quota exceeded"},
			},
			"mesgtoobig": [][]string{
				...
				[]string{"552", "5.3.4", "exceeded google's message size limits"},
				...
				// - https://support.google.com/mail/?p=MaxSizeError
				[]string{"552", "5.3.4", "exceeds google's message size limit of"},
			},
			"networkerror": [][]string{
				...
				[]string{"554", "5.4.6", "message exceeded 50 hops"},
				[]string{"554", "5.6.0", "message exceeded 50 hops"},
			},
			"norelaying": [][]string{
				...
				[]string{"550", "5.7.0", "mail relay denied"},
				...
				[]string{"550", "5.7.1", "invalid credentials for relay"},
				...
				[]string{"550", "5.7.1", "is not authorized to send email directly to our servers"},
			},
			"notcompliantrfc": [][]string{
				...
				[]string{"550", "5.7.1", "missing a valid address in the from: header"},
				[]string{"550", "5.7.1", "multiple addresses in from: header are not accepted"},
				...
				// - https://support.google.com/mail/?p=RfcMessageNonCompliant
				[]string{"550", "5.7.1", "is not rfc 5322 compliant"},

				// - 550 5.7.1 Messages missing a valid Message-ID: header are not accepted. For more
				//   information, go to Email sender guidelines and review RFC 5322 specifications.
				// - https://support.google.com/mail/?p=RfcMessageNonCompliant
				[]string{"550", "5.7.1", "missing a valid message-id: header"},
				...
				[]string{"550", "5.7.1", "contains a unicode character in a disallowed header"},
				...
				//   information, go to Email sender guidelines and review RFC 5322 specifications.
				// - https://support.google.com/mail/?p=RfcMessageNonCompliant
				[]string{"550", "5.7.1", "encoded-word syntax is not permitted"},
				...
				// - https://support.google.com/a/answer/3221692
				[]string{"553", "5.1.7", "is not a valid rfc 5321 address"},
				...
				// - https://support.google.com/mail/?p=RfcMessageNonCompliant
				[]string{"554", "5.6.0", "mail message is malformed"},
			},
			"policyviolation": [][]string{
				...
				//   guidelines.
				[]string{"552", "5.7.0", "illegal attachment on your message"},
				...
				[]string{"552", "5.7.0", "blocked because its content presents a potential security issue"},
				...
				[]string{"550", "5.7.1", "you are sending to (or from) has a policy that prohibited"},
				...
				[]string{"421", "4.7.28", "sending messages with the same message-id:"},
			},
			"rejected": [][]string{
				...
				// - https://support.google.com/a/answer/6140680//maildenied
				[]string{"550", "5.7.0", "mail sending denied"},
				[]string{"550", "5.7.1", "unauthenticated email is not accepted"},
			},
			"requireptr": [][]string{
				...
				//   For more information, go to Email sender guidelines.
				[]string{"421", "4.7.0",  "does not have a ptr record"},
				...
				[]string{"421", "4.7.23", " have a ptr record, or the ptr record"},
				...
				// - https://support.google.com/mail/answer/81126//ip-practices
				[]string{"550", "5.7.1",  "does not meet ipv6 sending guidelines regarding ptr records and authentication"},
				[]string{"550", "5.7.25", "does not have a ptr record"},
				[]string{"550", "5.7.25", "does not match the ip address of the hostname"},
			},
			"securityerror": [][]string{
				...
				[]string{"421", "4.7.0", "tls required for rcpt domain"},
				[]string{"454", "4.7.0", "too many login attempts"},

				// - 503 5.7.0 No identity changes permitted. For more information, go to About SMTP
				//   error messages.
				[]string{"501", "5.5.2", "cannot decode response"},   // 2FA related error, maybe.
				[]string{"503", "5.7.0", "no identity changes permitted"},
				...
				[]string{"530", "5.5.1", "authentication required."},
				[]string{"530", "5.7.0", "authentication required."},
				...
				[]string{"535", "5.7.1", "application-specific password required"},
				[]string{"535", "5.7.9", "application-specific password required"},
				...
				[]string{"535", "5.7.1",  "please log in with your web browser"},
				[]string{"534", "5.7.9",  "please log in with your web browser"},
				[]string{"534", "5.7.14", "please log in through your web browser"},

				// - 535 5.7.1 Username and Password not accepted. For more information, visit 
				//   https://support.google.com/accounts/troubleshooter/2402620
				[]string{"535", "5.7.1", "username and password not accepted"},
				[]string{"535", "5.7.8", "username and password not accepted"},
				...
				//   ections.
				[]string{"421", "4.7.29", "senders to use tls/ssl for smtp"},
				[]string{"550", "5.7.29", "senders to use tls/ssl for smtp"},
			},
			"spamdetected": [][]string{
				...
				//   https://support.google.com/mail/answer/188131
				[]string{"421", "4.7.0", "due to the nature of the content or the links within"},
				...
				[]string{"550", "5.7.1", "likely unsolicited mail"},
			},
			"speeding": [][]string{
				...
				[]string{"450", "4.2.1", "is receiving mail too quickly"},
				[]string{"450", "4.2.1", "peak smtp relay limit exceeded for customer"},
				...
				[]string{"450", "4.2.1", "rate that prevents additional messages from being delivered"},
				[]string{"550", "5.2.1", "rate that prevents additional messages from being delivered"},
				...
				[]string{"550", "5.4.5", "daily sending quota exceeded"},
				[]string{"550", "5.4.5", "daily user sending limit exceeded"},
				[]string{"550", "5.4.5", "daily smtp relay limit exceeded for"},
				[]string{"550", "5.7.1", "daily smtp relay limit exceeded for"},
				[]string{"550", "5.7.1", "daily smtp relay sending limit exceeded for"},
				[]string{"550", "5.7.1", "this mail has been rate limited"},
			},
			"suspend": [][]string{
				...
				[]string{"550", "5.2.1", "account that you tried to reach is disabled"},
				[]string{"550", "5.2.1", "account that you tried to reach is inactive"},
			},
			"syntaxerror": [][]string{
				...
				//   specifications.
				[]string{"451", "4.5.0",  "smtp protocol violation"},
				[]string{"454", "4.5.0",  "smtp protocol violation"},
				[]string{"525", "5.7.10", "smtp protocol violation"},
				[]string{"535", "5.5.4",  "optional argument not permitted"},
				[]string{"454", "5.5.1",  "starttls may not be repeated"},
				...
				[]string{"501", "5.7.11", "syntax error"},
				[]string{"501", "5.5.2",  "syntax error"},
				[]string{"555", "5.5.2",  "syntax error"},
				...
				//   specifications.
				// - https://support.google.com/a/answer/3221692
				[]string{"502", "5.5.1", "too many unrecognized commands, goodbye"},
				[]string{"502", "5.5.1", "unimplemented command"},
				[]string{"502", "5.5.1", "unrecognized command"},
				[]string{"503", "5.5.1", "bad sequence of commands"},
				[]string{"503", "5.5.1", "ehlo/helo first"},
				[]string{"503", "5.5.1", "mail first"},
				[]string{"503", "5.5.1", "rcpt first"},
				[]string{"503", "5.5.1", "no data after bdat"},
				[]string{"504", "5.7.4", "unrecognized authentication type"},
				[]string{"504", "5.7.4", "xoauth is no longer supported"},

				// - 530 5.7.0 Must issue a STARTTLS command first. For more information, go to About
				//   SMTP error messages and review RFC 3207 specifications.
				[]string{"530", "5.7.0", "must issue a starttls command first"},
				[]string{"554", "5.7.0", "too many unauthenticated commands"},
			},
			"systemerror": [][]string{
				// About SMTP error messages, https://support.google.com/a/answer/3221692
				[]string{"421", "4.3.0", "temporary system problem"},
				[]string{"421", "4.7.0", "temporary system problem"},
				[]string{"421", "4.4.5", "server busy"},
				...
				[]string{"451", "4.3.0", "multiple destination domains per transaction is unsupported"},
				[]string{"451", "4.3.0", "mail server has temporarily rejected this message"},
				[]string{"451", "4.3.0", "mail server temporarily rejected message"},
				...
				[]string{"452", "4.5.3", "domain policy size per transaction exceeded"},
				...
				//   https://support.google.com/a/answer/3221692
				[]string{"454", "4.7.0", "cannot authenticate due to temporary system problem"},
			},
			"toomanyconn": [][]string{
				...
				[]string{"452", "4.5.3", "your message has too many recipients"},
				[]string{"550", "5.5.3", "too many recipients for this sender"},
			},
			"userunknown": [][]string{
				...
				[]string{"550", "5.1.1", "the email account that you tried to reach does not exist"},
				...
				[]string{"553", "5.1.2", "we weren't able to find the recipient domain"},

				// - 553 5.1.3 The recipient address <address> is not a valid RFC 5321 address. For more
				//   information, go to About SMTP error messages and review RFC 5321 specifications.
				// - https://support.google.com/a/answer/3221692
				[]string{"553", "5.1.3", "is not a valid rfc 5321 address"},
			},
		}
		...
		REASON: for e := range messagesof {
			...
			for _, f := range messagesof[e] {
				...
				if strings.Contains(issuedcode, f[2]) == false { continue }
