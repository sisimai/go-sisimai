...
func TestLhostSurfControl(t *testing.T) {
	publiclist := [][]IsExpected{
		...
		{{"01",   1, "5.0.0",   "550", "filtered",        false, 1, ""}},
		{{"02",   1, "5.0.0",   "554", "systemerror",     false, 0, ""}},
		{{"03",   1, "5.0.0",   "554", "systemerror",     false, 0, ""}},
	}; EngineTest(t, "SurfControl", publiclist, true)

	secretlist := [][]IsExpected{
		// Label, Index, Status, ReplyCode, Reason, HardBounce, Toxic, AnotherOne
		{{"1001", 1, "5.0.0",   "550", "filtered",        false, 1, ""}},
		{{"1002", 1, "5.0.0",   "550", "filtered",        false, 1, ""}},
		{{"1003", 1, "5.0.0",   "550", "filtered",        false, 1, ""}},
		{{"1004", 1, "5.0.0",   "554", "systemerror",     false, 0, ""}},
		{{"1005", 1, "5.0.0",   "554", "systemerror",     false, 0, ""}},
