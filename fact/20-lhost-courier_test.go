...
func TestLhostCourier(t *testing.T) {
	publiclist := [][]IsExpected{
		...
		{{"02",   1, "5.0.0",   "550", "filtered",        false,  true, ""}},
		{{"03",   1, "5.7.1",   "550", "rejected",        false, false, ""}},
		{{"04",   1, "5.0.0",   "",    "hostunknown",      true,  true, ""}},
	}; EngineTest(t, "Courier", publiclist, true)

	secretlist := [][]IsExpected{
		// Label, Index, Status, ReplyCode, Reason, HardBounce, Toxic, AnotherOne
		{{"1001", 1, "5.0.0",   "550", "userunknown",      true,  true, ""}},
		{{"1002", 1, "5.0.0",   "550", "userunknown",      true,  true, ""}},
		{{"1003", 1, "5.7.1",   "550", "rejected",        false, false, ""}},
		{{"1004", 1, "5.0.0",   "550", "userunknown",      true,  true, ""}},
		{{"1005", 1, "5.1.1",   "550", "userunknown",      true,  true, ""}},
		{{"1006", 1, "5.1.1",   "550", "userunknown",      true,  true, ""}},
		{{"1007", 1, "5.0.0",   "550", "userunknown",      true,  true, ""}},
		{{"1008", 1, "5.1.1",   "550", "userunknown",      true,  true, ""}},
		{{"1009", 1, "5.0.0",   "550", "filtered",        false,  true, ""}},
		{{"1010", 1, "5.7.1",   "550", "rejected",        false, false, ""}},
		{{"1011", 1, "5.0.0",   "",    "hostunknown",      true,  true, ""}},
		{{"1012", 1, "5.0.0",   "",    "hostunknown",      true,  true, ""}},
