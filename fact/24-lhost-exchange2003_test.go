...
func TestLhostExchange2003(t *testing.T) {
	publiclist := [][]IsExpected{
		...
		{{"02",   1, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"02",   2, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"03",   1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"04",   1, "5.9.210", "",    "filtered",        false, false, ""}},
		{{"05",   1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"07",   1, "5.9.213", "",    "userunknown",      true,  true, ""}},
	}; EngineTest(t, "Exchange2003", publiclist, true)

	secretlist := [][]IsExpected{
		// Label, Index, Status, ReplyCode, Reason, HardBounce, Toxic, AnotherOne
		{{"1001", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1002", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		...
		{{"1015", 1, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015", 2, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015", 3, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015", 4, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015", 5, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015", 6, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015", 7, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015", 8, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015", 9, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015",10, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1015",11, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1016", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1017", 1, "5.9.210", "",    "filtered",        false, false, ""}},
		{{"1018", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1019", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1020", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1021", 1, "5.9.213", "",    "userunknown",      true,  true, ""},
		 {"1021", 2, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1022", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1023", 1, "5.9.210", "",    "filtered",        false, false, ""}},
		{{"1024", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		...
		{{"1030", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1031", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
		{{"1032", 1, "5.9.213", "",    "userunknown",      true,  true, ""}},
