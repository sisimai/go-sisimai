...
func TestLhostPostfix(t *testing.T) {
	publiclist := [][]IsExpected{
		...
		{{"79",   1, "5.2.0",   "",    "mailererror",     false, ""}},
		{{"80",   1, "5.1.0",   "550", "blocked",         false, ""}},
	...
	secretlist := [][]IsExpected{
		...
		{{"1034", 1, "5.0.0",   "550", "userunknown",      true, ""}},
		{{"1035", 1, "4.2.2",   "",    "mailboxfull",     false, ""}},
		{{"1036", 1, "5.4.4",   "",    "hostunknown",      true, ""}},
		{{"1037", 1, "5.0.0",   "550", "userunknown",      true, ""}},
		...
		{{"1101", 1, "5.0.0",   "554", "spamdetected",    false, ""}},
		...
		{{"1145", 1, "5.0.0",   "550", "userunknown",      true, ""}},
		...
		{{"1272", 1, "5.0.0",   "550", "userunknown",      true, ""}},
		{{"1273", 1, "5.0.0",   "550", "userunknown",      true, ""}},
		...
		{{"1281", 1, "5.1.1",   "550", "userunknown",      true, ""}},
		{{"1282", 1, "5.1.1",   "550", "userunknown",      true, ""}},
		{{"1283", 1, "5.4.4",   "",    "hostunknown",      true, ""}},
		{{"1284", 1, "5.0.0",   "552", "mailboxfull",     false, ""}},
		{{"1285", 1, "5.0.0",   "552", "mailboxfull",     false, ""}},
		{{"1286", 1, "5.7.0",   "552", "contenterror",    false, ""}},
		{{"1287", 1, "5.0.0",   "550", "rejected",        false, ""}},
		{{"1288", 1, "5.7.64",  "550", "norelaying",      false, ""}},
		{{"1289", 1, "5.1.0",   "",    "notaccept",        true, ""}},
		{{"1290", 1, "5.0.0",   "503", "syntaxerror",     false, ""}},
		{{"1291", 1, "5.0.0",   "501", "syntaxerror",     false, ""}},
		{{"1292", 1, "5.7.26",  "550", "authfailure",     false, ""}},
		{{"1293", 1, "4.4.1",   "",    "expired",         false, ""}},
		{{"1294", 1, "5.2.3",   "554", "exceedlimit",     false, ""}},
		{{"1295", 1, "4.7.650", "451", "badreputation",   false, ""}},
		{{"1296", 1, "5.0.0",   "554", "suspend",         false, ""}},
		{{"1297", 1, "5.2.2",   "552", "mailboxfull",     false, ""}},
		{{"1298", 1, "5.1.1",   "550", "userunknown",      true, ""}},
		{{"1299", 1, "4.7.1",   "453", "norelaying",      false, ""}},
		{{"1300", 1, "4.7.0",   "421", "blocked",         false, ""}},
		{{"1301", 1, "4.3.2",   "451", "speeding",        false, ""}},
		{{"1302", 1, "5.2.0",   "",    "mailererror",     false, ""}},
		{{"1303", 1, "5.0.0",   "550", "onhold",          false, ""}},
		{{"1304", 1, "5.0.0",   "550", "onhold",          false, ""}},
		{{"1305", 1, "5.0.0",   "550", "onhold",          false, ""}},
		{{"1306", 1, "4.0.0",   "451", "systemerror",     false, ""}},
		{{"1307", 1, "4.2.1",   "450", "speeding",        false, ""}},
		{{"1308", 1, "4.4.1",   "",    "networkerror",    false, ""}},
		{{"1309", 1, "4.3.5",   "451", "systemerror",     false, ""}},
		{{"1310", 1, "4.3.1",   "452", "systemfull",      false, ""}},
		...
		{{"1318", 1, "5.0.0",   "553", "norelaying",      false, ""}},
		{{"1319", 1, "4.0.0",   "450", "suspend",         false, ""}},
		{{"1320", 1, "5.7.7",   "554", "policyviolation", false, ""}},
		{{"1321", 1, "5.7.1",   "554", "rejected",        false, ""}},
		{{"1322", 1, "5.4.1",   "",    "rejected",        false, ""}},
		{{"1323", 1, "5.1.1",   "550", "userunknown",      true, ""}},
