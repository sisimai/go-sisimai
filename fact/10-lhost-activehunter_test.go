...
func TestLhostActivehunter(t *testing.T) {
	publiclist := [][]IsExpected{
		...
		{{"02",   1, "5.9.210", "550", "filtered",        false, 1, ""}},
	}
	...
	secretlist := [][]IsExpected{
		...
		{{"1003", 1, "5.3.0"  , "553", "filtered",        false, 1, ""}},
		{{"1004", 1, "5.7.17",  "550", "filtered",        false, 1, ""}},
		{{"1005", 1, "5.1.1",   "550", "userunknown",      true, 1, ""}},
		{{"1006", 1, "5.1.1",   "550", "userunknown",      true, 1, ""}},
		{{"1007", 1, "5.9.210", "550", "filtered",        false, 1, ""}},
		{{"1008", 1, "5.9.210", "550", "filtered",        false, 1, ""}},
		{{"1009", 1, "5.1.1",   "550", "userunknown",      true, 1, ""}},
		{{"1010", 1, "5.3.0",   "553", "filtered",        false, 1, ""}},
		{{"1011", 1, "5.7.17",  "550", "filtered",        false, 1, ""}},
