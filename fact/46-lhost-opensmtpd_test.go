...
func TestLhostOpenSMTPD(t *testing.T) {
	publiclist := [][]IsExpected{
		...
		{{"03",   1, "5.9.212", "",    "hostunknown",      true,  true, ""}},
		{{"04",   1, "5.9.341", "",    "networkerror",    false, false, ""}},
		{{"05",   1, "5.9.340", "",    "expired",         false, false, ""}},
		{{"06",   1, "5.9.340", "",    "expired",         false, false, ""}},
		{{"10",   1, "5.9.212", "",    "hostunknown",      true,  true, ""}},
		{{"11",   1, "5.7.26",  "550", "authfailure",     false, false, ""}},
		{{"12",   1, "5.9.215", "",    "notaccept",        true,  true, ""}},
		{{"13",   1, "4.7.0",   "421", "badreputation",   false, false, ""}},
		{{"14",   1, "5.7.25",  "550", "requireptr",      false, false, ""}},
		{{"15",   1, "5.9.340", "",    "expired",         false, false, ""}},
		{{"16",   1, "5.9.340", "",    "expired",         false, false, ""}},
	...
	secretlist := [][]IsExpected{
		...
		{{"1006", 1, "5.9.340", "",    "expired",         false, false, ""}},
		...
		{{"1013", 1, "5.9.212", "",    "hostunknown",      true,  true, ""}},
		{{"1014", 1, "5.9.340", "",    "expired",         false, false, ""}},
		{{"1015", 1, "5.9.341", "",    "networkerror",    false, false, ""}},
		{{"1016", 1, "5.9.212", "",    "hostunknown",      true,  true, ""}},
		{{"1017", 1, "5.7.26",  "550", "authfailure",     false, false, ""}},
		{{"1018", 1, "5.9.215", "",    "notaccept",        true,  true, ""}},
