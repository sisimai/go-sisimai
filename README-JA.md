...
には以下のような違いがありますが、解析精度や対応しているMTAやメール形式は同じです。
...
|------------------------------------------------------|--------------------|---------------------|
| 動作環境                                             | 1.17 -             | 5.26 -              |
| 依存モジュール数(標準パッケージ/コアモジュールを除く)| 2 パッケージ       | 2 モジュール        |
| ソースコードの行数                                   | 9,600 行           | 9,900 行            |
| テスト件数                                           | 134,000 件         | 319,000 件          |
| 1秒間に解析できるバウンスメール数[^4]                | 1200 通            | 400 通              |
| ライセンス                                           | 2条項BSD           | 2条項BSD            |
