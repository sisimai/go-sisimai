...
var TestEmailAddrs = []struct {testname string; argument string; expected string; displays string; comments string}{
	...
	{"", "<aoki@example.jp> Odd-Eyes Aoki (Blue, Yellow)", "aoki@example.jp", "Odd-Eyes Aoki", "(Blue, Yellow)"},
	...
	{"", `<"akari,chatora"@example.jp> akari@example.jp`, `"akari,chatora"@example.jp`, "akari@example.jp", ""},
	...
	{"", "neko(nyaan.jp)chan@example.jp", "nekochan@example.jp", "nekochan@example.jp", "(nyaan.jp)"},
	{"", `<"neko(nyaan.jp)chan"@example.jp>`, `"nekochan"@example.jp`, "", "(nyaan.jp)"},
